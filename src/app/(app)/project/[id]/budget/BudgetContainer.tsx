          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-white rounded-xl border border-navy-100/20 p-4">
              ...
              <div className="flex items-center gap-1 mt-1">
                <p className="text-2xl sm:text-xl font-semibold text-navy-800">Rp {globalBudgetLimit.toLocaleString('id-ID')}</p>
            ...
            <div className="bg-white rounded-xl border border-navy-100/20 p-4">
              ...
              <p className="text-2xl sm:text-xl font-semibold text-rose-gold-500 mt-1">Rp {totalSpent.toLocaleString('id-ID')}</p>
            </div>
            <div className="bg-white rounded-xl border border-navy-100/20 p-4">
              <p className="text-[10px] font-medium text-navy-400/40 uppercase">Remaining</p>
              <p className={`text-2xl sm:text-xl font-semibold mt-1 ${remaining >= 0 ? 'text-emerald-500' : 'text-red-500'}`}>Rp {remaining.toLocaleString('id-ID')}</p>
            </div>
          </div>
